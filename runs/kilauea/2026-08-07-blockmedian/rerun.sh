#!/bin/zsh
# Item 112: items 110-111 re-run verbatim against the block-median strength term.
# Pre-registered at eb0775f. Identical to ../2026-08-07-refbins/
...
O=/private/tmp/claude-501/-Users-matteoamico-Workspace-micromotion/cdb256dd-5a5b-4955-9cf1-adfbd7d0321e/scratchpad/blockmedian_results.txt
