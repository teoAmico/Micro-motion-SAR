#!/bin/zsh
# Item 107: look-count stabilization as a BLIND discriminator.
# Pre-registered at f6ad9f4. Twelve motionless scenes and six injected ones, each
