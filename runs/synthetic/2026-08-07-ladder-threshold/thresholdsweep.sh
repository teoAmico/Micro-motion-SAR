#!/bin/zsh
# Item 116: does the persistence threshold hold on seeds it was not fitted to?
# Pre-registered at HEAD. TWO arms: item 115s seeds (consistency, arithmetic
...
O=$D/ladder_threshold_results.txt
RUNGS=(96 128 160 192 224 256)
echo "kind seed chain verdict" > $O
