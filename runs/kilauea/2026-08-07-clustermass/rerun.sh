#!/bin/zsh
# Item 113: items 110-112 re-run verbatim against the permutation null on cluster mass.
# Pre-registered at 87d27eb. Identical to ../2026-08-07-blockmedian/
...
O=/private/tmp/claude-501/-Users-matteoamico-Workspace-micromotion/cdb256dd-5a5b-4955-9cf1-adfbd7d0321e/scratchpad/clustermass_results.txt
