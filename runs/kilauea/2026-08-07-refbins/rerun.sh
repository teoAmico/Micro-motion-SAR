#!/bin/zsh
# Item 111: item 110 re-run verbatim against the narrowed local neighbourhood.
# Pre-registered at 8885312. Identical to ../2026-08-07-nomination-fix/
# rerun109.sh in every flag; only the binary differs.
...
O=/private/tmp/claude-501/-Users-matteoamico-Workspace-micromotion/cdb256dd-5a5b-4955-9cf1-adfbd7d0321e/scratchpad/refbins_results.txt
