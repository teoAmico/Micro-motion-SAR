#!/bin/zsh
# Item 110: item 109 re-run verbatim against the fixed admission and ranking.
# Pre-registered at fce5869. Identical to ../2026-08-07-stable-weak-centred/
# stablecentred.sh in every flag; only the binary differs.
...
O=/private/tmp/claude-501/-Users-matteoamico-Workspace-micromotion/cdb256dd-5a5b-4955-9cf1-adfbd7d0321e/scratchpad/rerun109_results.txt
